# Contributing to DSKI on Github
We want to make contributing to this project as approachable and transparent as
possible.

## Code of Conduct
DSKI has adopted a Code of Conduct that we expect project
participants to adhere to. Please [read the full text](https://github.com/dskobe/.github/blob/master/CODE_OF_CONDUCT.md)
...
Before we can include your contribution in the DSKI project, you need to 
...
## License
By contributing to DSKI, you agree that your contributions will be licensed
